...
menuinicial = Tk()
menuinicial.title('Cadrasto de Doações - Casa de Apoio Betânia')
...
def atualizar():
    ...
    conn.close()
    '''    
    popup_atualizar.iconbitmap('C:\\Users\\Roberto\\Desktop\\Laza\\a.ico')
    ...
    popup_atualizar.configure(background='#c45238')
    popup_atualizar_label = Label(enquadramento_popup_atualizar, bg='#f5f5ce', text="Dado atualizado com sucesso.", pady=20, padx=10)

    popup_atualizar_btn = Button(enquadramento_popup_atualizar, text="OK", command=fecharpopup_atualizar, bg='white')
    '''
