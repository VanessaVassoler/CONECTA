...
#Criando DB
conn = sqlite3.connect('C:\\CasaBet\\doacao_CAB.db')
...
def set_widgets(self):
        ...
        self.dataCols = ('Nome', 'Data de Nascimento', 'Cidade', 'Data Ingresso', 'Data Saída', 'Paciente', 'Obs1', 'Hospital', 'Muitas Coisas')
        ...
        xsb.grid(row=1, column=0, sticky=tk.W+ tk.E)
